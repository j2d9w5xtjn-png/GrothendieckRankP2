...
-- 1) NN = 3, WITHOUT the fiber-killed-by-2 condition (pure bialgebra axioms)
runAll(3, false, fib1,  "fiber k[x,y]/(x^2,y^2), no fiber2")
runAll(3, false, fib2t, "fiber k[t]/(t^4), no fiber2")
